...
\newcommand{\liblinkx}[3]{\indexlink{#1}{libraryindex}{#2}{#3}}
	% Link to indexed position.
	%   arg 0: link text
...
\newcommand{\nontermdef}[1]{\indexedspan{#1\textnormal{:}}{\indexgrammar{\idxgram{#1}}}}
\newcommand{\grammarterm}[1]{\indexlink{\gterm{#1}}{grammarindex}{\idxgram{#1}|idxbfpage}{}}
\newcommand{\libglobal}[1]{\indexedspan{#1}{\indexlibraryglobal{#1}}}
...
\newcommand{\deflibconcept}[1]{\indexedspan{\cname{#1}}{\indexlibrary{\idxconcept{#1}}\indexconcept{\idxconcept{#1}|idxbfpage}}}
\newcommand{\defexposconcept}[1]{\indexedspan{\ecname{#1}}{\indexconcept{\idxexposconcept{#1}|idxbfpage}}}
\newcommand{\exposconcept}[1]{\indexedspan{\ecname{#1}}{\indexconcept{\idxexposconcept{#1}}}}
\newcommand{\exposconceptx}[2]{\indexedspan{\ecname{#1}}{\indexconcept{\idxexposconcept{#2}}}}
\newcommand{\noncxxtcode}[1]{\tcode{#1}}
\newcommand{\literaltcode}[1]{\tcode{#1}}
\newcommand{\defnx}[2]{\indexedspan{\textit{#1}}{\indexdefn{#2}}}
